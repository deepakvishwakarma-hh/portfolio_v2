    ...
    return (
        <section data-scroll-section className="flex items-center justify-center flex-col md:h-[100vh] h-[80vh]">
            <OutlineText onClick={scrollToTop} text="Back to top" classNames=" 
             4xl:text-h1-4xl 3xl:text-h1-3xl 2xl:text-h1-2xl xl:text-h1-xl lg:text-h1-lg md:text-h1-md text-h1-sm font-extrabold text-center cursor-pointer w-full ct" />
